...
class AppLocalizationsZh extends AppLocalizations {
  ...
  @override
  String get smartBillingAttachmentFormatWebpDesc => '保存自动附件时转为 WebP，通常比 JPEG 更省空间';

  @override
  String get smartBillingAttachmentFormatAvif => 'AVIF（优先节省空间）';

  @override
  String get smartBillingAttachmentFormatAvifDesc => '体积更小，适合节省空间；保存失败时会回退为 JPEG';
...
class AppLocalizationsZhTw extends AppLocalizationsZh {
  ...
  @override
  String get smartBillingAttachmentFormatWebpDesc => '儲存自動附件時轉為 WebP，通常比 JPEG 更省空間';

  @override
  String get smartBillingAttachmentFormatAvif => 'AVIF（優先節省空間）';

  @override
  String get smartBillingAttachmentFormatAvifDesc => '體積更小，適合節省空間；儲存失敗時會回退為 JPEG';
