...
IconData iconForCategory(String name) {
  ...
  if (n.contains('购物') ||
      ...
      n.contains('网购') ||
      n.contains('淘宝') ||
      n.contains('京东')) return Icons.shopping_bag_outlined;
  if (n.contains('社交') ||
      n.contains('聚会') ||
      n.contains('朋友') ||
      n.contains('聚餐')) return Icons.groups_outlined;
  if (n.contains('服饰') ||
      n.contains('衣') ||
      n.contains('鞋') ||
      n.contains('裤') ||
  ...
  if (n.contains('娱乐') ||
      n.contains('游戏') ||
      n.contains('电影') ||
      n.contains('影院')) return Icons.sports_esports_outlined;
  if (n.contains('居家') ||
      n.contains('家') ||
      n.contains('家居') ||
      n.contains('物业') ||
  ...
  if (n.contains('通讯') ||
      n.contains('话费') ||
      n.contains('宽带') ||
      n.contains('流量')) return Icons.network_cell_outlined;
  ...
  if (n.contains('礼物') ||
      ...
      n.contains('礼金') ||
      n.contains('请客') ||
      n.contains('人情')) return Icons.card_giftcard_outlined;
  if (n.contains('水') || n.contains('电') || n.contains('煤') || n.contains('燃气'))
    return Icons.water_drop_outlined;
  if (n.contains('房贷') ||
      n.contains('按揭') ||
      n.contains('贷款') ||
      n.contains('信用卡')) return Icons.account_balance_outlined;
  if (n.contains('住房') ||
      n.contains('房租') ||
      n.contains('房') ||
      n.contains('租')) return Icons.home_outlined;
  if (n.contains('工资') ||
      n.contains('收入') ||
      n.contains('奖金') ||
      n.contains('报销') ||
  ...
  if (n.contains('教育') ||
      n.contains('学习') ||
      n.contains('培训') ||
      n.contains('书')) return Icons.menu_book_outlined;
  if (n.contains('医疗') ||
      n.contains('医院') ||
      n.contains('药') ||
      n.contains('体检')) return Icons.medical_services_outlined;
  if (n.contains('宠物') || n.contains('猫') || n.contains('狗'))
    return Icons.pets_outlined;
  if (n.contains('运动') ||
      n.contains('健身') ||
      n.contains('球') ||
      n.contains('跑步')) return Icons.fitness_center_outlined;
  if (n.contains('数码') ||
      n.contains('电子') ||
      n.contains('手机') ||
      n.contains('电脑')) return Icons.devices_other_outlined;
  if (n.contains('旅行') ||
      n.contains('旅游') ||
      n.contains('出差') ||
      n.contains('机票')) return Icons.card_travel_outlined;
  ...
  if (n.contains('税') ||
      n.contains('社保') ||
      n.contains('公积金') ||
      n.contains('罚款')) return Icons.receipt_long_outlined;
