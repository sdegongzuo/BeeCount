...
abstract class AppLocalizations {
  ...
  /// No description provided for @smartBillingAttachmentFormat.
  ///
  /// In en, this message translates to:
  /// **'Attachment Image Format'**
  String get smartBillingAttachmentFormat;

  /// No description provided for @smartBillingAttachmentFormatJpeg.
  ///
  /// In en, this message translates to:
  /// **'JPEG (Best Compatibility)'**
  String get smartBillingAttachmentFormatJpeg;

  /// No description provided for @smartBillingAttachmentFormatJpegDesc.
  ///
  /// In en, this message translates to:
  /// **'Default compressed format with the best compatibility'**
  String get smartBillingAttachmentFormatJpegDesc;

  /// No description provided for @smartBillingAttachmentFormatWebp.
  ///
  /// In en, this message translates to:
  /// **'WebP (Save Space)'**
  String get smartBillingAttachmentFormatWebp;

  /// No description provided for @smartBillingAttachmentFormatWebpDesc.
  ///
  /// In en, this message translates to:
  /// **'Convert automatic attachments to WebP, usually smaller than JPEG'**
  String get smartBillingAttachmentFormatWebpDesc;

  /// No description provided for @smartBillingAttachmentFormatAvif.
  ///
  /// In en, this message translates to:
  /// **'AVIF (Smallest First)'**
  String get smartBillingAttachmentFormatAvif;
