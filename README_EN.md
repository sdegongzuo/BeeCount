...
- **Multi-Language Support**: Complete Chinese/English interface switching, with plans for more languages
...
- **Language Features**:
  ...
  - Automatic recognition and matching of English category names during CSV import
- **Planned Languages**:
  - Traditional Chinese 🇹🇼
  - 日本語 🇯🇵
  - 한국어 🇰🇷
...
> Welcome translation contributions! If you'd like to add support for a new language, please create an issue or submit a PR directly.
