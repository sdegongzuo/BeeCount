...
class ShareBillingForegroundService : Service() {
    ...
    private var billingRuleStorageBinding: BillingRuleEngineStorageBinding? = null
    ...
    override fun onDestroy() {
        ...
        engine?.destroy()
        billingRuleStorageBinding?.closeAfterEngineDestroyed()
        billingRuleStorageBinding = null
    ...
    private fun ensureBackgroundEngine() {
        ...
        billingRuleStorageBinding = BillingRuleEngineStorageBinding.attach(engine)
